...
const PreviewForm = ({ formData }) => {
  ...
  return (
    <Container className="preview-container">
      <div className="container mt-5 preview-container cont main-preview-container">
              ...
              <div className="info">
                ...
                <div className="row">
                  <div className="col-md-5">
                    <p>Weight: {formData.patweight} kg</p>
                  </div>
                  <div className="col-md-3">
                    <p>Height: {formData.patheight} cm</p>
                  </div>
                  <div className="col-md-2">
                    <p>Spo2: {formData.patsPo2}%</p>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-4">
                    <p>Blood Pressure: {formData.patbp} mmHg</p>
                  </div>
                  <div className="col-md-4">
                    <p>Temperature: {formData.pattemp}°C</p>
                  </div>
                </div>
                <div className="row ">
                  <div className="col-md-12">
        ...
        <div className="mt-5 text-center">
          <Button className="btn-style" onClick={handlePrint}>
            Print Prescription
          </Button>
        </div>
      </div>
